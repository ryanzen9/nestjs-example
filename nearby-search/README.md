---
title: 'Nest通关秘籍'
source: 'https://nest-docs.elias.ccwu.cc/82.%20Redis%20+%20%E9%AB%98%E5%BE%B7%E5%9C%B0%E5%9B%BE%EF%BC%8C%E5%AE%9E%E7%8E%B0%E9%99%84%E8%BF%91%E7%9A%84%E5%85%85%E7%94%B5%E5%AE%9D.html'
author:
published:
created: 2026-04-29
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-1.png)

这两天国庆节，大家出去玩可能会借用共享充电宝。它也是基于你的位置来搜索附近充电宝：

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-2.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-3.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-4.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-5.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-6.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-7.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-8.png)

因为两个点相距 166km，所以搜索 100km 以内的点，只能搜到一个。而 200km 的内的点，能搜到两个。

这样，我们就可以实现搜索附近 1km 的充电宝的功能。

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-9.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-10.png)

比如上面我们分别在地图上绘制了 marker 和 circle：

这是添加 Marker 的代码：

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-11.png)

指定 marker 的经纬度和图片就行。

这是添加 Circle 的代码：

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-12.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-13.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-14.png)

浏览器访问 [http://localhost:3000](http://localhost:3000/) 可以看到 hello world，就代表 nest 服务跑起来了：

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-15.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-16.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-17.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-18.png)

/addPos?name=guang&longitude=15&latitude=35

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-19.png)

/addPos?name=dong&longitude=15&latitude=85

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-20.png)

然后去 RedisInsight 里看下：

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-21.png)

点击刷新，可以看到确实有了 positions 的数据。

然后我们再添加个查询位置列表的接口：

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-22.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-23.png)

没啥问题。

在 AppController 添加两个路由：

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-24.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-25.png)

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-26.png)

最后，还要提供一个搜索附近的点的接口：

在 RedisService 添加 geoSearch 方法，传入 key，经纬度、搜索半径，返回附近的点：

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-27.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-28.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-29.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-30.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-31.png)

不过现在的经纬度我们是随便给的。

可以用高德地图的坐标拾取工具来取几个位置：

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-32.png)

天安门： 116.397444,39.909183

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-33.png)

文化宫科技馆：116.3993,39.908578

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-34.png)

售票处：116.397283,39.90943

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-35.png)

故宫彩扩部：116.398002,39.909175

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-36.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-37.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-38.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-39.png)

/nearbySearch?longitude=116.397444&latitude=39.909183&radius=0.05

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-40.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-41.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-42.png)

接下来要接入高德地图。

先按照 [文档](https://lbs.amap.com/api/javascript-api-v2/getting-started) 的步骤获取 key

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-43.png)

这个很简单，填一下信息就好。

点击 [创建新应用](https://console.amap.com/dev/key/app) ，选择 web 应用，就可以生成 key 了

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-44.png)

然后把文档的 [demo 代码](https://lbs.amap.com/demo/javascript-api-v2/example/map-componets/map-overlays) 复制过来：

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-45.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-46.png)

接下来引入 axios，来调用服务端接口：

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-47.png)
...
![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-48.png)

然后把 radius 改成 0.05，是这样的：

![](https://liushuaiyang.oss-cn-shanghai.aliyuncs.com/nest-docs/image/82-49.png)
